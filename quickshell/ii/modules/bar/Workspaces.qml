    ...
    Grid {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                color: ColorUtils.transparentize(Appearance.m3colors.m3secondaryContainer, 0.9)
                ...
                background: Item {
                    ...
                    StyledText { // Workspace number text
                        ...
                        color: (monitor?.activeWorkspace?.id == button.workspaceValue) ? 
                            Appearance.m3colors.m3onPrimary : // Warna jika AKTIF (tetap sama)
                            (workspaceOccupied[index] ? Appearance.m3colors.m3onSecondaryContainer : 
                                Appearance.colors.colOnSecondaryContainer) // <-- GANTI INI (Warna Putih untuk TIDAK AKTIF)
