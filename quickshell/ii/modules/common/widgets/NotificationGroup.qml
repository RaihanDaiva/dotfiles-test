...
MouseArea { // Notification group area
    ...
    Rectangle { // Background of the notification
        ...
        width: parent.width
        color: popup ? ColorUtils.applyAlpha(Appearance.colors.colLayer2, 1 - Appearance.backgroundTransparency) : ColorUtils.transparentize(Appearance.colors.colLayer1, 0.85)
        border.width: 0.5
