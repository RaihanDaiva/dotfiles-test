...
import qs.modules.common.functions // <--- PENTING: Untuk akses 'ColorUtils'
...
Item {
    ...
    Rectangle {
        ...
        color: "transparent"
        // color: Qt.rgba(0.1, 0.1, 0.1, 0.65)
        // color: Qt.rgba(255, 255, 255, 0.1)
        // Gunakan 0.6 atau 0.7 agar transparan tapi tetap gelap
        // color: ColorUtils.transparentize(Appearance.colors.colLayer0Border, 0.7)
        // border.width: 1
