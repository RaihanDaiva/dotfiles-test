...
// 🔌 POWER OPTIONS STYLE: ORIGINAL (Vertical Pill List with Pywal Styling)
Item {
    id: styleRoot
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: styleRoot.shutdownClicked()
            }
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                cursorShape: Qt.PointingHandCursor
                onClicked: styleRoot.rebootClicked()
            }
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                cursorShape: Qt.PointingHandCursor
                onClicked: styleRoot.suspendClicked()
            }
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                cursorShape: Qt.PointingHandCursor
                onClicked: styleRoot.lockClicked()
            }
        ...
        Rectangle {
            ...
            MouseArea {
                anchors.fill: parent
                cursorShape: Qt.PointingHandCursor
                onClicked: styleRoot.logoutClicked()
            }
